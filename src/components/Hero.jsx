        ...
        <div className="flex flex-wrap items-center justify-center">
            <div>
                <motion.div className="flex flex-col items-center lg:items-start mt-10" initial="hidden" animate="visible" variants={containerVariants}>
                    ...
                    <motion.a variants={childVariants} href="/AlexiSaravia-SoftwareEngineer-CV.pdf" target="_blank" rel="noopener noreferrer" download className="bg-white rounded-full p-4 text-sm text-stone-800 mb-10">Download Resume</motion.a>
                </motion.div>
            </div>
        </div>
    </div>
